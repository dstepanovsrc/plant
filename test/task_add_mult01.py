...
# Check the add task command for the multi projects
# Test:
# plan add <plan_name>
# task add <task_name1>
...
check_string = (
        ...
        common_func.create_project_str(17, 1, project_name5, 1, 1) +
        common_func.create_project_str(18, 2, project_name51, 0, 0) +
        common_func.create_project_str(19, 1, project_name6, 0, 1) +
        common_func.create_task_str(20, 2, task_name61, "P", 0, "   0:00:00", 0, "")
        )
