...
# Check the remove project command, for one project with subprojects and subtasks 
# Test:
# plan add <plan_name>
# task add <task_name1>
...
check_string = (
        ...
        common_func.create_task_str(7, 1, task_name4, "P", 0, "   0:00:00", 0, "") +
        ...
        common_func.create_task_str(11, 2, task_name61, "P", 0, "   0:00:00", 0, "")
        )
...
plant_issue([plan_app, "project", "remove", "7"])
