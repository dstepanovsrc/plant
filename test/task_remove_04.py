...
# Check the remove task command, for one task in the middle
# Test:
# plan add <plan_name>
# task add <task_name1>
...
check_string = (
        ...
        common_func.create_task_str(14, 2, task_name35, "P", 0, "   0:00:00", 0, "") +
        common_func.create_task_str(15, 1, task_name4, "P", 0, "   0:00:00", 0, "") +
        common_func.create_project_str(16, 1, project_name5, 1, 1) +
        common_func.create_project_str(17, 2, project_name51, 0, 0) +
        common_func.create_project_str(18, 1, project_name6, 0, 1) +
        common_func.create_task_str(19, 2, task_name61, "P", 0, "   0:00:00", 0, "")
        )
