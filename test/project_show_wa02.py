...
# Check the show project command, with the wrong project id
# Test:
# plan add <plan_name>
...
plant_check([plan_app, "project", "show", "300"], check_string)
