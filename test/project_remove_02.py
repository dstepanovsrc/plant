...
# Check the remove project command, remove only first element
# Test:
# plan add <plan_name>
...
check_string = (
        ...
        common_func.create_project_str(2, 2, project_name21, 0, 0) +
        common_func.create_project_str(3, 2, project_name22, 3, 3) +
        common_func.create_project_str(4, 3, project_name221, 2, 2) +
        common_func.create_project_str(5, 4, project_name2211, 0, 0) +
        common_func.create_project_str(6, 4, project_name2212, 0, 0) +
        common_func.create_project_str(7, 3, project_name222, 0, 0) +
        common_func.create_project_str(8, 3, project_name223, 0, 0) +
        common_func.create_project_str(9, 2, project_name23, 0, 0) +
        common_func.create_project_str(10, 1, project_name3, 0, 0)
        )
...
plant_issue([plan_app, "project", "remove", "1"])
