...
# Check the current plan command after switch with multicheck
# Test:
# plan add <plan_name1>
# plan add <plan_name2>
# plan current
# <check output, plan_name2>
...
plant_check([plan_app, "plan", "current"], check_string2)
plant_issue([plan_app, "plan", "switch", plan_name1])
plant_check([plan_app, "plan", "current"], check_string1)
