...
# Check the show project command
# Test:
# plan add <plan_name>
...
check_string = (
        ...
        common_func.create_project_str(7, 3, project_name2212, 0, 0) +
        common_func.create_project_str(8, 2, project_name222, 0, 0) +
        common_func.create_project_str(9, 2, project_name223, 0, 0)
        )
...
plant_check([plan_app, "project", "show", "4"], check_string)
