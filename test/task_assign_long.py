...
# Check the assign task command with the long name
# Test:
# plan add <plan_name>
# task add <task_name>
# task assign 1 reso1234567890
# plan show
# <check output>
...
check_string = (
        ...
        common_func.create_task_str(1, 1, task_name, "P", 0, "   0:00:00", 0, " reso12345")
        )

# Run all the process and check output
plant_issue([plan_app, "plan", "add", plan_name])
plant_issue([plan_app, "task", "add", task_name])
plant_issue([plan_app, "task", "assign", "1", "reso1234567890"])
