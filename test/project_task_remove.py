...
# Check the remove project and task command, for one several items
# Test:
# plan add <plan_name>
# task add <task_name1>
...
check_string = (
        ...
        common_func.create_task_str(10, 2, task_name35, "P", 0, "   0:00:00", 0, "") +
        common_func.create_task_str(11, 1, task_name4, "P", 0, "   0:00:00", 0, "") +
        common_func.create_project_str(12, 1, project_name5, 1, 1) +
        common_func.create_project_str(13, 2, project_name51, 0, 0) +
        common_func.create_project_str(14, 1, project_name6, 0, 1) +
        common_func.create_task_str(15, 2, task_name61, "P", 0, "   0:00:00", 0, "")
        )
...
plant_issue([plan_app, "project", "remove", "9"])
